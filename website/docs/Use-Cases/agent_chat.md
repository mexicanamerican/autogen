...
AutoGen offers a unified multi-agent conversation framework as a high-level abstraction for orchestrating multi-agent conversations and managing interactions between agents. It facilitates the integration of LLMs, human users, tools, or a combination of them through automated agent chat.
