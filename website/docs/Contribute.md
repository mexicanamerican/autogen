...
### Pre-commit\n-  Running tests and maintaining code coverage:\n   To run the tests, use the following command:\n   ```bash\n   cd test\n   coverage run -m pytest\n   cd ..\n   ```\n\n   To view the coverage report, use the following command:\n   ```bash\n   coverage report -m\n   cd ..\n   ```\n\n   The code coverage can also be viewed visually using the following command:\n   ```bash\n   coverage html\n   ```\n-  Building and testing the documentation locally:\n   To build and test the documentation, follow these steps:\n   1. Install Node.js by running the following command:\n   ```bash\n   nvm install --lts\n   ```\n   2. Install Yarn by running the following command:\n   ```bash\n   npm install --global yarn  # skip if you use the dev container we provided\n   ```\n   3. Install pydoc-markdown by running the following command:\n   ```bash\n   pip install pydoc-markdown  # skip if you use the dev container we provided\n   ```\n   4. Navigate to the 'website' directory by running the following command:\n   ```bash\n   cd website\n   ```\n   5. Install the necessary dependencies by running the following command:\n   ```bash\n   yarn install --frozen-lockfile --ignore-engines\n   ```\n   6. Start a local development server by running the following command:\n   ```bash\n   yarn start\n   ```\n   This will open a browser window and most changes will be reflected live without restarting the server.
