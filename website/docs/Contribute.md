...
When you submit an issue, please follow the updated guidelines for GitHub Issues outlined below:
- The ideal bug report should contain a short reproducible code snippet. This way anyone can try to reproduce the bug easily (see [this](https://stackoverflow.com/help/mcve) for more details). If the snippet is longer than 50 lines, please link to a [gist](https://gist.github.com) or a GitHub repo.
